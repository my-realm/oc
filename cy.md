...
The above riddle is posed to instill the feeling or emotion of "being curious" into the reader.   
...
Congratulations even if you had to reffer to the answer and feel satisfied with it.
Even if you have an answer that you are not going to verify with the given link and are otherwise satisfied, congratulations!
...
These further questions were posed for discusing the important and valuable formal methods of cybernetics.
And just before we dwell into that method, here is one final, quintessential question:
...
The question may now seem banal or mundane and yet, it serves a further purpose.
It can now be used to provide the essence of banality and a trite trivia without ever lessening the value of its answer. 
